        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-6 md:mb-0">
            ...
            <p className="mt-2 text-slate-400 max-w-md">
              Building innovative software solutions with a focus on user experience and performance.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-8">
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <a href="#home" className="text-slate-400 hover:text-teal-400 transition-colors duration-300">Home</a>
                </li>
                <li>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <a href="mailto:email@example.com" className="text-slate-400 hover:text-teal-400 transition-colors duration-300">email@example.com</a>
                </li>
                <li>
